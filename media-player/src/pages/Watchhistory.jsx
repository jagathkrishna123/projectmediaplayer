...
function Watchhistory(){
    ...
    return(
       <>
       <div className="container mt-5 d-flex justify-content-between align-center mb-5">
        <h4>Watch History</h4>
        <Link style={{color:"white"}} to={'/home'}><i class="fa-solid fa-arrow-left me-2"></i>Back to Home</Link>
       </div>
